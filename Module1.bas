...
inf_letters_data(32, 1) = 1159: inf_letters_data(32, 2) = 967 ' €
inf_letters_data(33, 1) = 0: inf_letters_data(33, 2) = 0 '
inf_letters_data(34, 1) = 1300: inf_letters_data(34, 2) = 900 ' Є  ' set manually - dk
...
NextWord:
    ...
    Fresheye = "јнализ завершЄн:" & vbCrLf & _
               " омбинаций слов проверено: " & words_checked & vbCrLf & _
               "—редн€€ плохость: " & Round(average_badness, 2) & vbCrLf & _
                vbCrLf & _
               "“еперь раскрасим слова"
...
Sub HighlightBadWords()
    ...
    syntaxSymbols = Array(",", ".", "/", "?", "!", ")", "(", "[", "]", "<", ">", """", "\", "Ђ", "ї", "У", "Ф", "Д", "Ч", ";", ":")
